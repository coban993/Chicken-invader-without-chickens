...
namespace wci
{
	FrontalWiper::FrontalWiper(Actor* owner, float cooldownTime, const sf::Vector2f& localOffset, float width)
		...
		mShooter5{ owner, cooldownTime/1.5f, {localOffset.x, localOffset.y - width / 1.2f}, -15.f, "SpaceShooterRedux/PNG/Lasers/laserGreen11.png" },
		mShooter6{ owner, cooldownTime/1.5f, {localOffset.x, localOffset.y + width / 1.2f}, 15.f, "SpaceShooterRedux/PNG/Lasers/laserGreen11.png" }
	{
	}
